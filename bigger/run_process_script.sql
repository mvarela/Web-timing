...
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://blog.flickr.net/en%' and mimetype like '%image%'  and size > 10000  ;
.output 'stats/html_stats-blog_flickr_net_en'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://blog.flickr.net/en%' and mimetype like '%html%'  ;
.output 'stats/javascript_stats-blog_flickr_net_en'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://blog.flickr.net/en%' and mimetype like '%javascript%'  ;
.output 'stats/css_stats-blog_flickr_net_en'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://blog.flickr.net/en%' and mimetype like '%css%'  ;
...
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://en.wikipedia.org/wiki/Main_Page%' and mimetype like '%image%'  and size > 10000  ;
.output 'stats/html_stats-en_wikipedia_org_wiki_Main_Page'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://en.wikipedia.org/wiki/Main_Page%' and mimetype like '%html%'  ;
.output 'stats/javascript_stats-en_wikipedia_org_wiki_Main_Page'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://en.wikipedia.org/wiki/Main_Page%' and mimetype like '%javascript%'  ;
.output 'stats/css_stats-en_wikipedia_org_wiki_Main_Page'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://en.wikipedia.org/wiki/Main_Page%' and mimetype like '%css%'  ;
...
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.amazon.com/%' and mimetype like '%image%'  and size > 10000  ;
.output 'stats/html_stats-www_amazon_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.amazon.com/%' and mimetype like '%html%'  ;
.output 'stats/javascript_stats-www_amazon_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.amazon.com/%' and mimetype like '%javascript%'  ;
.output 'stats/css_stats-www_amazon_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.amazon.com/%' and mimetype like '%css%'  ;
...
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.bbc.co.uk/news%' and mimetype like '%image%'  and size > 10000  ;
.output 'stats/html_stats-www_bbc_co_uk_news'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.bbc.co.uk/news%' and mimetype like '%html%'  ;
.output 'stats/javascript_stats-www_bbc_co_uk_news'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.bbc.co.uk/news%' and mimetype like '%javascript%'  ;
.output 'stats/css_stats-www_bbc_co_uk_news'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.bbc.co.uk/news%' and mimetype like '%css%'  ;
...
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.ebay.com/%' and mimetype like '%image%'  and size > 10000  ;
.output 'stats/html_stats-www_ebay_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.ebay.com/%' and mimetype like '%html%'  ;
.output 'stats/javascript_stats-www_ebay_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.ebay.com/%' and mimetype like '%javascript%'  ;
.output 'stats/css_stats-www_ebay_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.ebay.com/%' and mimetype like '%css%'  ;
...
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.google.com/%' and mimetype like '%image%'  and size > 10000  ;
.output 'stats/html_stats-www_google_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.google.com/%' and mimetype like '%html%'  ;
.output 'stats/javascript_stats-www_google_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.google.com/%' and mimetype like '%javascript%'  ;
.output 'stats/css_stats-www_google_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.google.com/%' and mimetype like '%css%'  ;
...
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.imdb.com/%' and mimetype like '%image%'  and size > 10000  ;
.output 'stats/html_stats-www_imdb_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.imdb.com/%' and mimetype like '%html%'  ;
.output 'stats/javascript_stats-www_imdb_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.imdb.com/%' and mimetype like '%javascript%'  ;
.output 'stats/css_stats-www_imdb_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.imdb.com/%' and mimetype like '%css%'  ;
...
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.npr.org/%' and mimetype like '%image%'  and size > 10000  ;
.output 'stats/html_stats-www_npr_org_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.npr.org/%' and mimetype like '%html%'  ;
.output 'stats/javascript_stats-www_npr_org_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.npr.org/%' and mimetype like '%javascript%'  ;
.output 'stats/css_stats-www_npr_org_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.npr.org/%' and mimetype like '%css%'  ;
...
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.yle.fi/%' and mimetype like '%image%'  and size > 10000  ;
.output 'stats/html_stats-www_yle_fi_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.yle.fi/%' and mimetype like '%html%'  ;
.output 'stats/javascript_stats-www_yle_fi_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.yle.fi/%' and mimetype like '%javascript%'  ;
.output 'stats/css_stats-www_yle_fi_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.yle.fi/%' and mimetype like '%css%'  ;
...
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.youtube.com/%' and mimetype like '%image%'  and size > 10000  ;
.output 'stats/html_stats-www_youtube_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.youtube.com/%' and mimetype like '%html%'  ;
.output 'stats/javascript_stats-www_youtube_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.youtube.com/%' and mimetype like '%javascript%'  ;
.output 'stats/css_stats-www_youtube_com_'
select (r.starttimeoffset*1000) as starttime, r.duration, r.size, (( r.starttimeoffset*1000 ) +r.duration) as total from measurements as m join requests as r on m.archivename = r.mid where starttime >= 0 and duration >= 0 and m.url like '%http://www.youtube.com/%' and mimetype like '%css%'  ;
